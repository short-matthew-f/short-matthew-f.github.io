...
function repair(src){
  ...
  src=src.replace("var VERSION='1.11.7';","var VERSION='1.11.9';");
  src=src.replace(/engine-v117-bootstrap\.js/g,'engine-v119-bootstrap.js');
  return src;
}
fetch('engine-v117-loader.js?v=20260818-117')
 ...
 .then(function(src){
   ...
   try{fn=new Function(repaired+'\n//# sourceURL=engine-v119-loader-runtime.js');}
