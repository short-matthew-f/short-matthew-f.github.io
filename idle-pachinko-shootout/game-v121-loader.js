...
fetch('game-v12-loader.js?v=20260817-3',{cache:'no-store'}).then(function(r){if(!r.ok)throw new Error('Could not load v1.2 engine ('+r.status+')');return r.text();}).then(function(loader){
