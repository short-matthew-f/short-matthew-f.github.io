const CACHE='lane-warden-m0-0.2.3';
const ASSETS=['./','./index.html','./styles.css','./decision-legibility.css','./config.js','./rules.js','./r01c-runtime-adapter.js','./main.js','./decision-legibility.js','./manifest.webmanifest'];
