(function(root,factory){
  ...
  const BUILD='M1-0.4.1';
  const FIXTURE='R-02-STRUCTURAL';
  const PARAM_REV='R02-B';
  const DESIGN_BASELINE='1.7';

  // R02-B is a targeted exploratory revision from the first human structural run.
  // It strengthens the unattended-lane clock and makes Rival scoring less absence-dominant.
