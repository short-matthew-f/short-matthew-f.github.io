const CACHE='lane-warden-test10-0.9.1-v1';
const ASSETS=['./','./index.html','./test10.js','./manifest.webmanifest','./LW-T10-002-DECLARATION.md','./README.md','./VERSION','../lane-warden-test10-v0.9.0/index.html','../lane-warden-test10-v0.9.0/test10.js'];
