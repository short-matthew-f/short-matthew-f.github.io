const CACHE_PREFIX='lane-warden-r02-0.4.0-';
const CACHE=CACHE_PREFIX+'v1';
const ASSETS=['./','./index.html','./config.js','./rules.js','./main.js','./main-loader.js','./manifest.webmanifest','../lane-warden-m0-v0.2.4/styles.css','../lane-warden-m0-v0.2.4/attention-signaling.css'];
