...
function syncBuild(){document.querySelectorAll('.build-id').forEach(x=>x.textContent='0.12.0');const r=$('regression');if(r&&r.textContent)r.textContent=r.textContent.replace(/P1-0\.11\.0|P1-0\.11\.1|P1-0\.11\.2/g,BUILD)}
