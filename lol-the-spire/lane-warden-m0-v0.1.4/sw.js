const CACHE='lane-warden-m0-0.1.4';
const ASSETS=['./','./index.html','./instrumentation.js','./manifest.webmanifest','../lane-warden-m0-v0.1.2/styles.css','../lane-warden-m0-v0.1.1/main.js','../lane-warden-m0-v0.1.1/icon.svg'];
