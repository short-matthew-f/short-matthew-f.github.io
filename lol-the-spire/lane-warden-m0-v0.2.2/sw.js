const CACHE='lane-warden-m0-0.2.2';
const ASSETS=['./','./index.html','./styles.css','./decision-legibility.css','./config.js','./rules.js','./main.js','./decision-legibility.js','./manifest.webmanifest'];
