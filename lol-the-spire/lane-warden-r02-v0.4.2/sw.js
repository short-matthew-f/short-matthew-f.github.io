const CACHE_PREFIX='lane-warden-r02-0.4.2-';
const CACHE=CACHE_PREFIX+'v1';
const ASSETS=['./','./index.html','./config.js','./main-loader.js','./manifest.webmanifest','./REFORM-001.md','./README.md','../lane-warden-r02-v0.4.0/main.js','../lane-warden-r02-v0.4.0/rules.js','../lane-warden-m0-v0.2.4/styles.css','../lane-warden-m0-v0.2.4/attention-signaling.css'];
